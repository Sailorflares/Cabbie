...
@User1 = User.create(:name => "funkychicken88", :email => 'funkychicken88@gmail.com', :password => 'p' , :password_confirmation => 'p' )
@User2 = User.create(:name => "chattyskunk1995", :email => 'chattyskunk1995@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User3 = User.create(:name => "anonymousdog_01", :email => 'anonymousdog_01@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User4 = User.create(:name => "ruby_lover_no1", :email => 'ruby_lover_no1@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User5 = User.create(:name => "jQuery_geek", :email => 'jQuery_geek@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User6 = User.create(:name => "NYC_citygal101", :email => 'NYC_citygal101@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User7 = User.create(:name => "chocolatetwinkie", :email => 'chocolatetwinkie88@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User8 = User.create(:name => "cheesecake_luver", :email => 'cheesecake_luver@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User9 = User.create(:name => "taxifan_757", :email => 'taxifan_757@gmail.com', :password => 'p' , :password_confirmation => 'p')
@User10 = User.create(:name => "javascript_guy42", :email => 'javascript_guy42@gmail.com', :password => 'p' , :password_confirmation => 'p')
