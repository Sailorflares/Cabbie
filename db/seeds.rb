...
@review13 = @User2.ride_reviews.create(:driver_id => 78346, :star_rating => 4, :comments => "Pretty quick ride. Didn't say any weird things to me. Would ride again.")
@review14 = @User3.ride_reviews.create(:driver_id => 78346, :star_rating => 1, :comments => "Worst experience ever!!!!!! A cockroach ran over my foot!! WTF, MAN.", :uber => true)
@review15 = @User4.ride_reviews.create(:driver_id => 78346, :star_rating => 2, :comments => "Average taxi driver. Would've given him 3 stars, but his cab isn't very clean.")
@review16 = @User5.ride_reviews.create(:driver_id => 78346, :star_rating => 4, :comments => "Super fun guy to talk to, makes great jokes! Got me from the UWS to Chinatown in 10 minutes!", :uber => true)
@review17 = @User6.ride_reviews.create(:driver_id => 78346, :star_rating => 2, :comments => "Average cabbie. Doesn't make conversation, takes you to where you want to go.")
@review18 = @User11.ride_reviews.create(:driver_id => 78346, :star_rating => 1, :comments => "NEVER AGAIN.",:uber => true)
@review19 = @User8.ride_reviews.create(:driver_id => 78346, :star_rating => 1, :comments => "This guy fell asleep. Do NOT ride with him.", :uber => true)
@review20 = @User9.ride_reviews.create(:driver_id => 78346, :star_rating => 2, :comments => "Took me all over town and up 8th Ave instead of the West Side Highway! And then yelled at me when I said that he was overcharging!! Skip this cab.", :uber => true)
@review21 = @User10.ride_reviews.create(:driver_id => 78346, :star_rating => 4, :comments => "Great cab driver, gave us some good recommendations of where to eat while we were in New York!")
